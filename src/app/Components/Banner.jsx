...
const Banner = () => {
  return (
    <>
      <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-5 h-full lg:min-h-screen bg-[#135276] rounded-b-[50px] md:items-center p-5 md:px-10 lg:mb-36">
        {/* Support  */}
        <div className="absolute -bottom-28 left-1/2 transform -translate-x-1/2 w-9/12 hidden lg:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {/* 1st Box  */}
