    ...
    <div className="container mx-auto p-6">
      ...
      <div className="grid md:grid-cols-3 sm:grid-cols-1 gap-6">
        ...
        <div className="card bg-base-100 shadow-xl">
          <figure>
            <Image src="https://i.ibb.co.com/C5ZSwwPS/asset-16.jpg" alt="React Course" width={300} height={200} />
          </figure>
          <div className="card-body">
            <span className="badge badge-primary">Web Development</span>
            <h2 className="card-title">Build Dynamic Web Applications with React</h2>
        ...
        <div className="card bg-base-100 shadow-xl">
          <figure>
            <Image src="https://i.ibb.co.com/mVkQNhR8/asset-17.jpg" alt="UI/UX Course" width={300} height={200}/>
          </figure>
          <div className="card-body">
        ...
        <div className="card bg-base-100 shadow-xl">
          <figure>
            <Image src="https://i.ibb.co.com/7xWTcRGt/asset-18.jpg" alt="Game Development" width={300} height={200} />
          </figure>
          <div className="card-body">
